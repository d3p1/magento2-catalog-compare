...
A [Magento 2](https://business.adobe.com/products/magento/magento-commerce.html) implementation that allows you to configure if the [product compare](https://docs.magento.com/user-guide/marketing/product-compare.html) feature is enabled.
...
```
composer require d3p1/module-catalog-compare
